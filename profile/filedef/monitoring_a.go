...
//
// There are two monitoring files, MonitoringA and MonitoringB, which are identical apart
// from supporting different conventions for file_id.number and the start of accumulating data values.
//
