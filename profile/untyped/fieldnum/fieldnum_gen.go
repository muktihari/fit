...
const (
	AccelerometerDataAccelX                           = 2   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	AccelerometerDataAccelY                           = 3   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	AccelerometerDataAccelZ                           = 4   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	AccelerometerDataCalibratedAccelX                 = 5   // [Type: Float32, Base: float32, Array: [N], Units: g]; Calibrated accel reading
	AccelerometerDataCalibratedAccelY                 = 6   // [Type: Float32, Base: float32, Array: [N], Units: g]; Calibrated accel reading
	AccelerometerDataCalibratedAccelZ                 = 7   // [Type: Float32, Base: float32, Array: [N], Units: g]; Calibrated accel reading
	AccelerometerDataCompressedCalibratedAccelX       = 8   // [Type: Sint16, Base: sint16, Array: [N], Units: mG]; Calibrated accel reading
	AccelerometerDataCompressedCalibratedAccelY       = 9   // [Type: Sint16, Base: sint16, Array: [N], Units: mG]; Calibrated accel reading
	AccelerometerDataCompressedCalibratedAccelZ       = 10  // [Type: Sint16, Base: sint16, Array: [N], Units: mG]; Calibrated accel reading
	AccelerometerDataSampleTimeOffset                 = 1   // [Type: Uint16, Base: uint16, Array: [N], Units: ms]; Each time in the array describes the time at which the accelerometer sample with the corrosponding index was taken. Limited to 30 samples in each message. The samples may span across seconds. Array size must match the number of samples in accel_x and accel_y and accel_z
	...
	AntRxData                                         = 4   // [Type: Byte, Base: byte, Array: [N]];
	AntRxFractionalTimestamp                          = 0   // [Type: Uint16, Base: uint16, Scale: 32768, Offset: 0, Units: s];
	AntRxMesgData                                     = 2   // [Type: Byte, Base: byte, Array: [N]];
	...
	AntTxData                                         = 4   // [Type: Byte, Base: byte, Array: [N]];
	AntTxFractionalTimestamp                          = 0   // [Type: Uint16, Base: uint16, Scale: 32768, Offset: 0, Units: s];
	AntTxMesgData                                     = 2   // [Type: Byte, Base: byte, Array: [N]];
	AntTxMesgId                                       = 1   // [Type: Byte, Base: byte];
	AntTxTimestamp                                    = 253 // [Type: DateTime, Base: uint32, Units: s];
	AviationAttitudeAccelLateral                      = 4   // [Type: Sint16, Base: sint16, Array: [N], Scale: 100, Offset: 0, Units: m/s^2]; Range -78.4 to +78.4 (-8 Gs to 8 Gs)
	AviationAttitudeAccelNormal                       = 5   // [Type: Sint16, Base: sint16, Array: [N], Scale: 100, Offset: 0, Units: m/s^2]; Range -78.4 to +78.4 (-8 Gs to 8 Gs)
	AviationAttitudeAttitudeStageComplete             = 8   // [Type: Uint8, Base: uint8, Array: [N], Units: %]; The percent complete of the current attitude stage. Set to 0 for attitude stages 0, 1 and 2 and to 100 for attitude stage 3 by AHRS modules that do not support it. Range - 100
	AviationAttitudePitch                             = 2   // [Type: Sint16, Base: sint16, Array: [N], Scale: 10430.38, Offset: 0, Units: radians]; Range -PI/2 to +PI/2
	AviationAttitudeRoll                              = 3   // [Type: Sint16, Base: sint16, Array: [N], Scale: 10430.38, Offset: 0, Units: radians]; Range -PI to +PI
	AviationAttitudeStage                             = 7   // [Type: AttitudeStage, Base: enum, Array: [N]];
	AviationAttitudeSystemTime                        = 1   // [Type: Uint32, Base: uint32, Array: [N], Units: ms]; System time associated with sample expressed in ms.
	...
	AviationAttitudeTrack                             = 9   // [Type: Uint16, Base: uint16, Array: [N], Scale: 10430.38, Offset: 0, Units: radians]; Track Angle/Heading Range 0 - 2pi
	AviationAttitudeTurnRate                          = 6   // [Type: Sint16, Base: sint16, Array: [N], Scale: 1024, Offset: 0, Units: radians/second]; Range -8.727 to +8.727 (-500 degs/sec to +500 degs/sec)
	AviationAttitudeValidity                          = 10  // [Type: AttitudeValidity, Base: uint16, Array: [N]];
	BarometerDataBaroPres                             = 2   // [Type: Uint32, Base: uint32, Array: [N], Units: Pa]; These are the raw ADC reading. The samples may span across seconds. A conversion will need to be done on this data once read.
	BarometerDataSampleTimeOffset                     = 1   // [Type: Uint16, Base: uint16, Array: [N], Units: ms]; Each time in the array describes the time at which the barometer sample with the corrosponding index was taken. The samples may span across seconds. Array size must match the number of samples in baro_cal
	...
	BeatIntervalsTime                                 = 1   // [Type: Uint16, Base: uint16, Array: [N], Units: ms]; Array of millisecond times between beats
	...
	BikeProfileFrontGear                              = 39  // [Type: Uint8z, Base: uint8z, Array: [N]]; Number of teeth on each gear 0 is innermost
	...
	BikeProfileRearGear                               = 41  // [Type: Uint8z, Base: uint8z, Array: [N]]; Number of teeth on each gear 0 is innermost
	...
	CapabilitiesLanguages                             = 0   // [Type: Uint8z, Base: uint8z, Array: [N]]; Use language_bits_x types where x is index of array.
	CapabilitiesSports                                = 1   // [Type: SportBits0, Base: uint8z, Array: [N]]; Use sport_bits_x types where x is index of array.
	...
	DeviceSettingsDefaultPage                         = 57  // [Type: Uint16, Base: uint16, Array: [N]]; Bitfield to indicate one page as default for each supported loop
	...
	DeviceSettingsPagesEnabled                        = 40  // [Type: Uint16, Base: uint16, Array: [N]]; Bitfield to configure enabled screens for each supported loop
	...
	DeviceSettingsTimeMode                            = 4   // [Type: TimeMode, Base: enum, Array: [N]]; Display mode for the time
	DeviceSettingsTimeOffset                          = 2   // [Type: Uint32, Base: uint32, Array: [N], Units: s]; Offset from system time.
	DeviceSettingsTimeZoneOffset                      = 5   // [Type: Sint8, Base: sint8, Array: [N], Scale: 4, Offset: 0, Units: hr]; timezone offset in 1/4 hour increments
	...
	DiveAlarmDiveTypes                                = 5   // [Type: SubSport, Base: enum, Array: [N]]; Dive types the alarm will trigger on
	...
	DiveApneaAlarmDiveTypes                           = 5   // [Type: SubSport, Base: enum, Array: [N]]; Dive types the alarm will trigger on
	...
	ExdDataFieldConfigurationTitle                    = 5   // [Type: String, Base: string, Array: [32]];
	...
	ExerciseTitleWktStepName                          = 2   // [Type: String, Base: string, Array: [N]];
	...
	FieldDescriptionFieldName                         = 3   // [Type: String, Base: string, Array: [N]];
	...
	FieldDescriptionUnits                             = 8   // [Type: String, Base: string, Array: [N]];
	...
	GpsMetadataVelocity                               = 7   // [Type: Sint16, Base: sint16, Array: [3], Scale: 100, Offset: 0, Units: m/s]; velocity[0] is lon velocity. Velocity[1] is lat velocity. Velocity[2] is altitude velocity.
	GyroscopeDataCalibratedGyroX                      = 5   // [Type: Float32, Base: float32, Array: [N], Units: deg/s]; Calibrated gyro reading
	GyroscopeDataCalibratedGyroY                      = 6   // [Type: Float32, Base: float32, Array: [N], Units: deg/s]; Calibrated gyro reading
	GyroscopeDataCalibratedGyroZ                      = 7   // [Type: Float32, Base: float32, Array: [N], Units: deg/s]; Calibrated gyro reading
	GyroscopeDataGyroX                                = 2   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	GyroscopeDataGyroY                                = 3   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	GyroscopeDataGyroZ                                = 4   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	GyroscopeDataSampleTimeOffset                     = 1   // [Type: Uint16, Base: uint16, Array: [N], Units: ms]; Each time in the array describes the time at which the gyro sample with the corrosponding index was taken. Limited to 30 samples in each message. The samples may span across seconds. Array size must match the number of samples in gyro_x and gyro_y and gyro_z
	...
	HrEventTimestamp                                  = 9   // [Type: Uint32, Base: uint32, Array: [N], Scale: 1024, Offset: 0, Units: s];
	HrEventTimestamp12                                = 10  // [Type: Byte, Base: byte, Array: [N], Scale: 1024, Offset: 0, Units: s];
	HrFilteredBpm                                     = 6   // [Type: Uint8, Base: uint8, Array: [N], Units: bpm];
	...
	HrvTime                                           = 0   // [Type: Uint16, Base: uint16, Array: [N], Scale: 1000, Offset: 0, Units: s]; Time between beats
	...
	LapAvgCadencePosition                             = 108 // [Type: Uint8, Base: uint8, Array: [N], Units: rpm]; Average cadence by position. Data value indexes defined by rider_position_type.
	...
	LapAvgLeftPowerPhase                              = 102 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average left power phase angles. Data value indexes defined by power_phase_type.
	LapAvgLeftPowerPhasePeak                          = 103 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average left power phase peak angles. Data value indexes defined by power_phase_type.
	...
	LapAvgPowerPosition                               = 106 // [Type: Uint16, Base: uint16, Array: [N], Units: watts]; Average power by position. Data value indexes defined by rider_position_type.
	...
	LapAvgRightPowerPhase                             = 104 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average right power phase angles. Data value indexes defined by power_phase_type.
	LapAvgRightPowerPhasePeak                         = 105 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average right power phase peak angles. Data value indexes defined by power_phase_type.
	LapAvgRightTorqueEffectiveness                    = 92  // [Type: Uint8, Base: uint8, Scale: 2, Offset: 0, Units: percent];
	LapAvgSaturatedHemoglobinPercent                  = 87  // [Type: Uint16, Base: uint16, Array: [N], Scale: 10, Offset: 0, Units: %]; Avg percentage of hemoglobin saturated with oxygen
	...
	LapAvgTotalHemoglobinConc                         = 84  // [Type: Uint16, Base: uint16, Array: [N], Scale: 100, Offset: 0, Units: g/dL]; Avg saturated and unsaturated hemoglobin
	...
	LapMaxCadencePosition                             = 109 // [Type: Uint8, Base: uint8, Array: [N], Units: rpm]; Maximum cadence by position. Data value indexes defined by rider_position_type.
	...
	LapMaxPowerPosition                               = 107 // [Type: Uint16, Base: uint16, Array: [N], Units: watts]; Maximum power by position. Data value indexes defined by rider_position_type.
	LapMaxRespirationRate                             = 148 // [Type: Uint8, Base: uint8];
	LapMaxSaturatedHemoglobinPercent                  = 89  // [Type: Uint16, Base: uint16, Array: [N], Scale: 10, Offset: 0, Units: %]; Max percentage of hemoglobin saturated with oxygen
	LapMaxSpeed                                       = 14  // [Type: Uint16, Base: uint16, Scale: 1000, Offset: 0, Units: m/s];
	LapMaxTemperature                                 = 51  // [Type: Sint8, Base: sint8, Units: C];
	LapMaxTotalHemoglobinConc                         = 86  // [Type: Uint16, Base: uint16, Array: [N], Scale: 100, Offset: 0, Units: g/dL]; Max saturated and unsaturated hemoglobin
	...
	LapMinSaturatedHemoglobinPercent                  = 88  // [Type: Uint16, Base: uint16, Array: [N], Scale: 10, Offset: 0, Units: %]; Min percentage of hemoglobin saturated with oxygen
	LapMinTemperature                                 = 124 // [Type: Sint8, Base: sint8, Units: C];
	LapMinTotalHemoglobinConc                         = 85  // [Type: Uint16, Base: uint16, Array: [N], Scale: 100, Offset: 0, Units: g/dL]; Min saturated and unsaturated hemoglobin
	...
	LapStrokeCount                                    = 75  // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; stroke_type enum used as the index
	LapSubSport                                       = 39  // [Type: SubSport, Base: enum];
	LapSwimStroke                                     = 38  // [Type: SwimStroke, Base: enum];
	LapTimeInCadenceZone                              = 59  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	LapTimeInHrZone                                   = 57  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	LapTimeInPowerZone                                = 60  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	LapTimeInSpeedZone                                = 58  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	...
	LapZoneCount                                      = 76  // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; zone number used as the index
	...
	LengthStrokeCount                                 = 20  // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; stroke_type enum used as the index
	...
	LengthZoneCount                                   = 21  // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; zone number used as the index
	MagnetometerDataCalibratedMagX                    = 5   // [Type: Float32, Base: float32, Array: [N], Units: G]; Calibrated Magnetometer reading
	MagnetometerDataCalibratedMagY                    = 6   // [Type: Float32, Base: float32, Array: [N], Units: G]; Calibrated Magnetometer reading
	MagnetometerDataCalibratedMagZ                    = 7   // [Type: Float32, Base: float32, Array: [N], Units: G]; Calibrated Magnetometer reading
	MagnetometerDataMagX                              = 2   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	MagnetometerDataMagY                              = 3   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	MagnetometerDataMagZ                              = 4   // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; These are the raw ADC reading. Maximum number of samples is 30 in each message. The samples may span across seconds. A conversion will need to be done on this data once read.
	MagnetometerDataSampleTimeOffset                  = 1   // [Type: Uint16, Base: uint16, Array: [N], Units: ms]; Each time in the array describes the time at which the compass sample with the corrosponding index was taken. Limited to 30 samples in each message. The samples may span across seconds. Array size must match the number of samples in cmps_x and cmps_y and cmps_z
	...
	MemoGlobData                                      = 4   // [Type: Uint8z, Base: uint8z, Array: [N]]; Block of utf8 bytes. Note, mutltibyte characters may be split across adjoining memo_glob messages.
	MemoGlobFieldNum                                  = 3   // [Type: Uint8, Base: uint8]; Field within the parent that this glob is associated with
	MemoGlobMemo                                      = 0   // [Type: Byte, Base: byte, Array: [N]]; Deprecated. Use data field.
	...
	MonitoringActivityTime                            = 16  // [Type: Uint16, Base: uint16, Array: [8], Units: minutes]; Indexed using minute_activity_level enum
	...
	MonitoringInfoActivityType                        = 1   // [Type: ActivityType, Base: enum, Array: [N]];
	MonitoringInfoCyclesToCalories                    = 4   // [Type: Uint16, Base: uint16, Array: [N], Scale: 5000, Offset: 0, Units: kcal/cycle]; Indexed by activity_type
	MonitoringInfoCyclesToDistance                    = 3   // [Type: Uint16, Base: uint16, Array: [N], Scale: 5000, Offset: 0, Units: m/cycle]; Indexed by activity_type
	...
	ObdiiDataPidDataSize                              = 4   // [Type: Uint8, Base: uint8, Array: [N]]; Optional, data size of PID[i]. If not specified refer to SAE J1979.
	ObdiiDataRawData                                  = 3   // [Type: Byte, Base: byte, Array: [N]]; Raw parameter data
	...
	ObdiiDataSystemTime                               = 5   // [Type: Uint32, Base: uint32, Array: [N]]; System time associated with sample expressed in ms, can be used instead of time_offset. There will be a system_time value for each raw_data element. For multibyte pids the system_time is repeated.
	ObdiiDataTimeOffset                               = 1   // [Type: Uint16, Base: uint16, Array: [N], Units: ms]; Offset of PID reading [i] from start_timestamp+start_timestamp_ms. Readings may span accross seconds.
	...
	RecordCompressedSpeedDistance                     = 8   // [Type: Byte, Base: byte, Array: [3], Scale: 100, Offset: 0, Units: m/s,m];
	...
	RecordLeftPowerPhase                              = 69  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Left power phase angles. Data value indexes defined by power_phase_type.
	RecordLeftPowerPhasePeak                          = 70  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Left power phase peak angles. Data value indexes defined by power_phase_type.
	...
	RecordRightPowerPhase                             = 71  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Right power phase angles. Data value indexes defined by power_phase_type.
	RecordRightPowerPhasePeak                         = 72  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Right power phase peak angles. Data value indexes defined by power_phase_type.
	...
	RecordSpeed1S                                     = 17  // [Type: Uint8, Base: uint8, Array: [N], Scale: 16, Offset: 0, Units: m/s]; Speed at 1s intervals. Timestamp field indicates time of last array element.
	...
	SegmentFileLeaderActivityId                       = 9   // [Type: Uint32, Base: uint32, Array: [N]]; Activity ID of each leader in the segment file
	SegmentFileLeaderActivityIdString                 = 10  // [Type: String, Base: string, Array: [N]]; String version of the activity ID of each leader in the segment file. 21 characters long for each ID, express in decimal
	SegmentFileLeaderGroupPrimaryKey                  = 8   // [Type: Uint32, Base: uint32, Array: [N]]; Group primary key of each leader in the segment file
	SegmentFileLeaderType                             = 7   // [Type: SegmentLeaderboardType, Base: enum, Array: [N]]; Leader type of each leader in the segment file
	...
	SegmentLapAvgCadencePosition                      = 81  // [Type: Uint8, Base: uint8, Array: [N], Units: rpm]; Average cadence by position. Data value indexes defined by rider_position_type.
	...
	SegmentLapAvgLeftPowerPhase                       = 75  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average left power phase angles. Data value indexes defined by power_phase_type.
	SegmentLapAvgLeftPowerPhasePeak                   = 76  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average left power phase peak angles. Data value indexes defined by power_phase_type.
	...
	SegmentLapAvgPowerPosition                        = 79  // [Type: Uint16, Base: uint16, Array: [N], Units: watts]; Average power by position. Data value indexes defined by rider_position_type.
	...
	SegmentLapAvgRightPowerPhase                      = 77  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average right power phase angles. Data value indexes defined by power_phase_type.
	SegmentLapAvgRightPowerPhasePeak                  = 78  // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average right power phase peak angles. Data value indexes defined by power_phase_type.
	...
	SegmentLapMaxCadencePosition                      = 82  // [Type: Uint8, Base: uint8, Array: [N], Units: rpm]; Maximum cadence by position. Data value indexes defined by rider_position_type.
	...
	SegmentLapMaxPowerPosition                        = 80  // [Type: Uint16, Base: uint16, Array: [N], Units: watts]; Maximum power by position. Data value indexes defined by rider_position_type.
	...
	SegmentLapTimeInCadenceZone                       = 51  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	SegmentLapTimeInHrZone                            = 49  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	SegmentLapTimeInPowerZone                         = 52  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	SegmentLapTimeInSpeedZone                         = 50  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	...
	SegmentPointLeaderTime                            = 5   // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s]; Accumualted time each leader board member required to reach the described point. This value is zero for all leader board members at the starting point of the segment.
	...
	SessionAvgCadencePosition                         = 122 // [Type: Uint8, Base: uint8, Array: [N], Units: rpm]; Average cadence by position. Data value indexes defined by rider_position_type.
	...
	SessionAvgLeftPowerPhase                          = 116 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average left power phase angles. Indexes defined by power_phase_type.
	SessionAvgLeftPowerPhasePeak                      = 117 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average left power phase peak angles. Data value indexes defined by power_phase_type.
	...
	SessionAvgPowerPosition                           = 120 // [Type: Uint16, Base: uint16, Array: [N], Units: watts]; Average power by position. Data value indexes defined by rider_position_type.
	...
	SessionAvgRightPowerPhase                         = 118 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average right power phase angles. Data value indexes defined by power_phase_type.
	SessionAvgRightPowerPhasePeak                     = 119 // [Type: Uint8, Base: uint8, Array: [N], Scale: 0.7111111, Offset: 0, Units: degrees]; Average right power phase peak angles data value indexes defined by power_phase_type.
	SessionAvgRightTorqueEffectiveness                = 102 // [Type: Uint8, Base: uint8, Scale: 2, Offset: 0, Units: percent];
	SessionAvgSaturatedHemoglobinPercent              = 98  // [Type: Uint16, Base: uint16, Array: [N], Scale: 10, Offset: 0, Units: %]; Avg percentage of hemoglobin saturated with oxygen
	...
	SessionAvgTotalHemoglobinConc                     = 95  // [Type: Uint16, Base: uint16, Array: [N], Scale: 100, Offset: 0, Units: g/dL]; Avg saturated and unsaturated hemoglobin
	...
	SessionMaxCadencePosition                         = 123 // [Type: Uint8, Base: uint8, Array: [N], Units: rpm]; Maximum cadence by position. Data value indexes defined by rider_position_type.
	...
	SessionMaxPowerPosition                           = 121 // [Type: Uint16, Base: uint16, Array: [N], Units: watts]; Maximum power by position. Data value indexes defined by rider_position_type.
	SessionMaxRespirationRate                         = 148 // [Type: Uint8, Base: uint8];
	SessionMaxSaturatedHemoglobinPercent              = 100 // [Type: Uint16, Base: uint16, Array: [N], Scale: 10, Offset: 0, Units: %]; Max percentage of hemoglobin saturated with oxygen
	...
	SessionMaxTotalHemoglobinConc                     = 97  // [Type: Uint16, Base: uint16, Array: [N], Scale: 100, Offset: 0, Units: g/dL]; Max saturated and unsaturated hemoglobin
	...
	SessionMinSaturatedHemoglobinPercent              = 99  // [Type: Uint16, Base: uint16, Array: [N], Scale: 10, Offset: 0, Units: %]; Min percentage of hemoglobin saturated with oxygen
	SessionMinTemperature                             = 150 // [Type: Sint8, Base: sint8, Units: C];
	SessionMinTotalHemoglobinConc                     = 96  // [Type: Uint16, Base: uint16, Array: [N], Scale: 100, Offset: 0, Units: g/dL]; Min saturated and unsaturated hemoglobin
	...
	SessionStrokeCount                                = 85  // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; stroke_type enum used as the index
	...
	SessionTimeInCadenceZone                          = 67  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	SessionTimeInHrZone                               = 65  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	SessionTimeInPowerZone                            = 68  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	SessionTimeInSpeedZone                            = 66  // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	...
	SessionZoneCount                                  = 86  // [Type: Uint16, Base: uint16, Array: [N], Units: counts]; zone number used as the index
	SetCategory                                       = 7   // [Type: ExerciseCategory, Base: uint16, Array: [N]];
	SetCategorySubtype                                = 8   // [Type: Uint16, Base: uint16, Array: [N]]; Based on the associated category, see [category]_exercise_names
	...
	ThreeDSensorCalibrationOffsetCal                  = 4   // [Type: Sint32, Base: sint32, Array: [3]]; Internal calibration factors, one for each: xy, yx, zx
	ThreeDSensorCalibrationOrientationMatrix          = 5   // [Type: Sint32, Base: sint32, Array: [9], Scale: 65535, Offset: 0]; 3 x 3 rotation matrix (row major)
	...
	TimeInZoneCadenceZoneHighBondary                  = 8   // [Type: Uint8, Base: uint8, Array: [N], Units: rpm];
	TimeInZoneFunctionalThresholdPower                = 15  // [Type: Uint16, Base: uint16];
	TimeInZoneHrCalcType                              = 10  // [Type: HrZoneCalc, Base: enum];
	TimeInZoneHrZoneHighBoundary                      = 6   // [Type: Uint8, Base: uint8, Array: [N], Units: bpm];
	TimeInZoneMaxHeartRate                            = 11  // [Type: Uint8, Base: uint8];
	TimeInZonePowerZoneHighBoundary                   = 9   // [Type: Uint16, Base: uint16, Array: [N], Units: watts];
	...
	TimeInZoneSpeedZoneHighBoundary                   = 7   // [Type: Uint16, Base: uint16, Array: [N], Scale: 1000, Offset: 0, Units: m/s];
	TimeInZoneThresholdHeartRate                      = 13  // [Type: Uint8, Base: uint8];
	TimeInZoneTimeInCadenceZone                       = 4   // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	TimeInZoneTimeInHrZone                            = 2   // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	TimeInZoneTimeInPowerZone                         = 5   // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	TimeInZoneTimeInSpeedZone                         = 3   // [Type: Uint32, Base: uint32, Array: [N], Scale: 1000, Offset: 0, Units: s];
	...
	UserProfileGlobalId                               = 23  // [Type: Byte, Base: byte, Array: [6]];
