...
const (
	...
	BikeProfileAutoPowerZero                          = 13  // [ BikeProfile ] [Type: Bool, Base: bool];
	BikeProfileAutoWheelCal                           = 12  // [ BikeProfile ] [Type: Bool, Base: bool];
	...
	BikeProfileCadEnabled                             = 16  // [ BikeProfile ] [Type: Bool, Base: bool];
	...
	BikeProfileEnabled                                = 20  // [ BikeProfile ] [Type: Bool, Base: bool];
	...
	BikeProfilePowerEnabled                           = 18  // [ BikeProfile ] [Type: Bool, Base: bool];
	...
	BikeProfileShimanoDi2Enabled                      = 44  // [ BikeProfile ] [Type: Bool, Base: bool];
	BikeProfileSpdEnabled                             = 15  // [ BikeProfile ] [Type: Bool, Base: bool];
	BikeProfileSpdcadEnabled                          = 17  // [ BikeProfile ] [Type: Bool, Base: bool];
	...
	ConnectivityAntEnabled                            = 2   // [ Connectivity ] [Type: Bool, Base: bool]; Use ANT for connectivity features
	ConnectivityAutoActivityUploadEnabled             = 7   // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityBluetoothEnabled                      = 0   // [ Connectivity ] [Type: Bool, Base: bool]; Use Bluetooth for connectivity features
	ConnectivityBluetoothLeEnabled                    = 1   // [ Connectivity ] [Type: Bool, Base: bool]; Use Bluetooth Low Energy for connectivity features
	ConnectivityCourseDownloadEnabled                 = 8   // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityGpsEphemerisDownloadEnabled           = 10  // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityGrouptrackEnabled                     = 12  // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityIncidentDetectionEnabled              = 11  // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityLiveTrackingEnabled                   = 4   // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityName                                  = 3   // [ Connectivity ] [Type: String, Base: string];
	ConnectivityWeatherAlertsEnabled                  = 6   // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityWeatherConditionsEnabled              = 5   // [ Connectivity ] [Type: Bool, Base: bool];
	ConnectivityWorkoutDownloadEnabled                = 9   // [ Connectivity ] [Type: Bool, Base: bool];
	...
	CoursePointFavorite                               = 8   // [ CoursePoint ] [Type: Bool, Base: bool];
	...
	DeviceSettingsActivityTrackerEnabled              = 36  // [ DeviceSettings ] [Type: Bool, Base: bool]; Enabled state of the activity tracker functionality
	...
	DeviceSettingsBleAutoUploadEnabled                = 86  // [ DeviceSettings ] [Type: Bool, Base: bool]; Automatically upload using BLE
	...
	DeviceSettingsLactateThresholdAutodetectEnabled   = 80  // [ DeviceSettings ] [Type: Bool, Base: bool]; Enable auto-detect setting for the lactate threshold feature.
	DeviceSettingsMountingSide                        = 56  // [ DeviceSettings ] [Type: Side, Base: enum];
	DeviceSettingsMoveAlertEnabled                    = 46  // [ DeviceSettings ] [Type: Bool, Base: bool]; Enabled state of the move alert
	...
	DiveAlarmEnabled                                  = 2   // [ DiveAlarm ] [Type: Bool, Base: bool]; Enablement flag
	...
	DiveAlarmPopupEnabled                             = 7   // [ DiveAlarm ] [Type: Bool, Base: bool]; Show a visible pop-up for this alarm
	DiveAlarmRepeating                                = 10  // [ DiveAlarm ] [Type: Bool, Base: bool]; Repeat alarm each time threshold is crossed?
	...
	DiveAlarmTriggerOnAscent                          = 9   // [ DiveAlarm ] [Type: Bool, Base: bool]; Trigger the alarm on ascent
	DiveAlarmTriggerOnDescent                         = 8   // [ DiveAlarm ] [Type: Bool, Base: bool]; Trigger the alarm on descent
	...
	DiveApneaAlarmEnabled                             = 2   // [ DiveApneaAlarm ] [Type: Bool, Base: bool]; Enablement flag
	...
	DiveApneaAlarmPopupEnabled                        = 7   // [ DiveApneaAlarm ] [Type: Bool, Base: bool]; Show a visible pop-up for this alarm
	DiveApneaAlarmRepeating                           = 10  // [ DiveApneaAlarm ] [Type: Bool, Base: bool]; Repeat alarm each time threshold is crossed?
	...
	DiveApneaAlarmTriggerOnAscent                     = 9   // [ DiveApneaAlarm ] [Type: Bool, Base: bool]; Trigger the alarm on ascent
	DiveApneaAlarmTriggerOnDescent                    = 8   // [ DiveApneaAlarm ] [Type: Bool, Base: bool]; Trigger the alarm on descent
	...
	DiveSettingsApneaCountdownEnabled                 = 12  // [ DiveSettings ] [Type: Bool, Base: bool];
	...
	DiveSettingsSafetyStopEnabled                     = 9   // [ DiveSettings ] [Type: Bool, Base: bool];
	...
	DiveSettingsUpKeyEnabled                          = 30  // [ DiveSettings ] [Type: Bool, Base: bool]; Indicates whether the up key is enabled during dives
	...
	ExdDataConceptConfigurationIsSigned               = 11  // [ ExdDataConceptConfiguration ] [Type: Bool, Base: bool];
	...
	ExdScreenConfigurationScreenEnabled               = 3   // [ ExdScreenConfiguration ] [Type: Bool, Base: bool];
	...
	GoalEnabled                                       = 10  // [ Goal ] [Type: Bool, Base: bool];
	...
	GoalRepeat                                        = 6   // [ Goal ] [Type: Bool, Base: bool];
	...
	HrmProfileEnabled                                 = 0   // [ HrmProfile ] [Type: Bool, Base: bool];
	...
	HrmProfileLogHrv                                  = 2   // [ HrmProfile ] [Type: Bool, Base: bool];
	...
	MaxMetDataCalibratedData                          = 9   // [ MaxMetData ] [Type: Bool, Base: bool]; Indicates if calibrated data was used in the calculation
	...
	ScheduleCompleted                                 = 4   // [ Schedule ] [Type: Bool, Base: bool]; TRUE if this activity has been started
	...
	SdmProfileEnabled                                 = 0   // [ SdmProfile ] [Type: Bool, Base: bool];
	...
	SdmProfileSpeedSource                             = 4   // [ SdmProfile ] [Type: Bool, Base: bool]; Use footpod for speed source instead of GPS
	...
	SegmentFileEnabled                                = 3   // [ SegmentFile ] [Type: Bool, Base: bool]; Enabled state of the segment file
	...
	SegmentIdEnabled                                  = 3   // [ SegmentId ] [Type: Bool, Base: bool]; Segment enabled for evaluation
