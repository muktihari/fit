...
func NewDeviceAuxBatteryInfo(mesg *proto.Message) *DeviceAuxBatteryInfo {
	m := new(DeviceAuxBatteryInfo)
	m.Reset(mesg)
	return m
}

// Reset resets all DeviceAuxBatteryInfo's fields based on given mesg.
// If mesg is nil, all fields will be set to its corresponding invalid value.
func (m *DeviceAuxBatteryInfo) Reset(mesg *proto.Message) {
	var (
