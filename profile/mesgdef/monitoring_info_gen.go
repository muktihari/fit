...
// Reset resets all MonitoringInfo's fields based on given mesg.
// If mesg is nil, all fields will be set to its corresponding invalid value.
func (m *MonitoringInfo) Reset(mesg *proto.Message) {
	var (
	...
	if mesg != nil {
		knownNums := [4]uint64{59, 0, 0, 2305843009213693952}
