...
func NewMonitoringHrData(mesg *proto.Message) *MonitoringHrData {
	m := new(MonitoringHrData)
	m.Reset(mesg)
	return m
}

// Reset resets all MonitoringHrData's fields based on given mesg.
// If mesg is nil, all fields will be set to its corresponding invalid value.
func (m *MonitoringHrData) Reset(mesg *proto.Message) {
	var (
...
func (m *MonitoringHrData) ToMesg(options *Options) proto.Message {
	...
	mesg := proto.Message{Num: typedef.MesgNumMonitoringHrData}
